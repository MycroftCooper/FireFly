...
namespace EditorTool
{
    ...
    public class ExcelConfig
    {
        ...
        // 存放自动生成cs模板
        public static readonly string excelCodePath = "Assets/Data/Excel_Scripts/";
        // 存放Excel生成的Asset池
        public static readonly string excelPoolPath = "Assets/Data/Excel_Assets/";
        // 存放Excel生成的独立Asset（如需）
        public static readonly string excelAssetPath = "Assets/Data/Excel_Assets/";
